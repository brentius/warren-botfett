...
#            quantity = int((capital / len(extracted)) / price)
            ...
            if action == "BUY" and stock not in portfolio:
                ...
                available_capital -= price * quantity
            
            elif action == "SELL" and stock in portfolio:
                sell_quantity = portfolio[stock]["quantity"]
                ...
                available_capital += price * sell_quantity
                del portfolio[stock]
    ...
    for stock, info in portfolio.items():
        ...
        available_capital += final_price * quantity
    ...
    def compute_backtest_metrics(portfolio_df, trades):
        ...
        print(f"Final capital: ${available_capital}")
